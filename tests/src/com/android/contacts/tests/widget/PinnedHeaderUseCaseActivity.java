...
package edu.bupt.contacts.tests.widget;

import edu.bupt.contacts.tests.R;
import edu.bupt.contacts.widget.PinnedHeaderListView;
...
public class PinnedHeaderUseCaseActivity extends ListActivity {
    ...
    private void startActivity(int[] counts, String[] names, boolean[] headers,
        ...
        intent.setComponent(new ComponentName("edu.bupt.contacts",
                "edu.bupt.contacts.widget.PinnedHeaderListDemoActivity"));
