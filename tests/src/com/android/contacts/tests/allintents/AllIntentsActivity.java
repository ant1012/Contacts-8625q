...
package edu.bupt.contacts.tests.allintents;

import edu.bupt.contacts.tests.R;
...
public class AllIntentsActivity extends ListActivity
    ...
    private static final String ANDROID_CONTACTS_PACKAGE = "edu.bupt.contacts";

    private static final String CONTACT_LIST_ACTIVITY_CLASS_NAME =
            "edu.bupt.contacts.activities.PeopleActivity";
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        switch (ContactsIntent.get(position)) {
            ...
            case LEGACY_CALL_DETAILS_ACTIVITY: {
                ...
                intent.setData(uri);
                bindIntentToClass(intent, "edu.bupt.contacts.CallDetailActivity");
                startActivity(intent);
                break;
            }
            case LEGACY_CALL_LOG_ACTIVITY: {
                startActivity(bindIntentToClass(new Intent(),
                        "edu.bupt.contacts.activities.CallLogActivity"));
                break;
            }
