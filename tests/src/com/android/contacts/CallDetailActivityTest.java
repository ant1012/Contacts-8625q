...
import static edu.bupt.contacts.CallDetailActivity.Tasks.UPDATE_PHONE_CALL_DETAILS;
import static edu.bupt.contacts.voicemail.VoicemailPlaybackPresenter.Tasks.CHECK_FOR_CONTENT;
import static edu.bupt.contacts.voicemail.VoicemailPlaybackPresenter.Tasks.PREPARE_MEDIA_PLAYER;

import edu.bupt.contacts.util.AsyncTaskExecutors;
import edu.bupt.contacts.util.FakeAsyncTaskExecutor;
import edu.bupt.contacts.util.IntegrationTestUtils;
import edu.bupt.contacts.util.LocaleTestUtils;
