 ...
 *
 * adb shell am instrument -w -e class edu.bupt.contacts.model.AccountTypeTest \
       edu.bupt.contacts.tests/android.test.InstrumentationTestRunner
 */
@SmallTest
public class AccountTypeTest extends AndroidTestCase {
    public void testGetResourceText() {
        ...
        final int internalResId = edu.bupt.contacts.R.string.launcherDialer;
