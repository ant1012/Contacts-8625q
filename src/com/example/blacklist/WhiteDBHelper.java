...
public class WhiteDBHelper extends SQLiteOpenHelper {   
    ...
    public WhiteDBHelper(Context context, String name,    
    ...
    public void addPeople(String name, String phone, String blockContent, Integer blockId) {
        ...
        this.getWritableDatabase().insert(
                WhiteDBHelper.TB_NAME, WhiteDBHelper.ID, values);  
    }
    
    public void delPeople(int id) {
        this.getWritableDatabase().delete(
                WhiteDBHelper.TB_NAME, WhiteDBHelper.ID + " = " + id, null);
    }
    
    public void delAllPeople() {
        this.getWritableDatabase().delete(
                WhiteDBHelper.TB_NAME, null, null);
    }
}