...
public class MenuCalendar extends Activity {
    public static final Uri CONTENT_URI = Uri
            .parse("content://edu.bupt.calendar.attendee/AttendeePhone");//
...
//修改日记界面 ddd
    public void onCreate(Bundle savedInstanceState) {
        ...
        SimpleAdapter adapter = new SimpleAdapter(this, list,
                R.layout.calendar_item, new String[] { "title",
                        "eventLocation", "dtstart", "dtend", "description" },
                new int[] { R.id.title, R.id.eventLocation, R.id.dtstart,
                        R.id.dtend, R.id.description });
    ...
    private void getCalendarEvent() {
        ...
        while (cur.getCount() > cur.getPosition()) {
            ...
            String eventLocation = cur.getString(cur
