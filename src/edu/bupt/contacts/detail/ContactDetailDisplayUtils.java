...
import edu.bupt.contacts.ContactLoader.Result;
import edu.bupt.contacts.ContactPhotoManager;
import edu.bupt.contacts.R;
import edu.bupt.contacts.preference.ContactsPreferences;
import edu.bupt.contacts.util.ContactBadgeUtil;
import edu.bupt.contacts.util.HtmlUtils;
import edu.bupt.contacts.util.MoreMath;
import edu.bupt.contacts.util.StreamItemEntry;
import edu.bupt.contacts.util.StreamItemPhotoEntry;
