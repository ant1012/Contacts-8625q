...
public class Switch extends CompoundButton {
    ...
    public Switch(Context context, AttributeSet attrs) {
        this(context, attrs, R.style.AppSwitch);
...
//        mTextPaint.setCompatibilityScaling(res.getCompatibilityInfo().applicationScale);
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,R.styleable.Switch, defStyle, defStyle);

        mThumbDrawable = a.getDrawable(R.styleable.Switch_thumbs);
        mTrackDrawable = a.getDrawable(R.styleable.Switch_tracks);
        ...
        Log.i(TAG,"mTextOn="+mTextOn+",mTextOff="+mTextOff+",mThumbTextPadding="+mThumbTextPadding);
...
//        }
    ...
    */
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN: {
                ...
                if (isEnabled() && hitThumb(x, y)) {
                    Log.i(TAG, "onTouchEvent()-ACTION_DOWN--11");
            ...
            case MotionEvent.ACTION_MOVE: {
                Log.i(TAG, "onTouchEvent()-ACTION_MOVE--mTouchMode="+mTouchMode);
                switch (mTouchMode) {
                    ...
                    case TOUCH_MODE_DOWN: {
                        ...
                        if (Math.abs(x - mTouchX) > mTouchSlop ||
                            ...
                            Log.i(TAG, "onTouchEvent()---TOUCH_MODE_DRAGGING--");
            ...
            case MotionEvent.ACTION_CANCEL: {
                if (mTouchMode == TOUCH_MODE_DRAGGING) {
                    Log.d(TAG, "onTouchEvent()--ACTION_CANCEL-TOUCH_MODE_DRAGGING-start to stopDrag()");
                    stopDrag(ev);
                    return true;
                } else {
                    Log.d(TAG, "onTouchEvent()--ACTION_CANCEL--onClick");
                    // click
    ...
    private void stopDrag(MotionEvent ev) {
        ...
        cancelSuperTouch(ev);
        Log.d(TAG,"stopDrag()--commitChange="+commitChange);
        if (commitChange) {
            boolean newState;
    ...
    private void animateThumbToCheckedState(boolean newCheckedState) {
        Log.d(TAG,"animateThumbToCheckedState()--newCheckedState="+newCheckedState);
        // TODO animate!
    ...
    private boolean getTargetCheckedState() {
        Log.i(TAG, "getTargetCheckedState()");
        if (isLayoutRtl()) {
            Log.i(TAG, "getTargetCheckedState()1111");
            return mThumbPosition <= getThumbScrollRange() / 2;
        } else {
            Log.i(TAG, "getTargetCheckedState()2222");
            return mThumbPosition >= getThumbScrollRange() / 2;
        }
    }
    ...
    public boolean isLayoutRtl() {
        ...
        if (targetSdkVersion < 17) {//JELLY_BEAN_MR1
            return false;
        } else {
            return true;
        }
    ...
    public int getCompoundPaddingLeft() {
        Log.d(TAG,"getCompoundPaddingLeft()");
        if (!isLayoutRtl()) {
    ...
    public int getCompoundPaddingRight() {
        Log.d(TAG,"getCompoundPaddingRight()");
        if (isLayoutRtl()) {
    ...
    protected int[] onCreateDrawableState(int extraSpace) {
        ...
        Log.d(TAG,"onCreateDrawableState()--extraSpace="+extraSpace+",drawableState="+Arrays.toString(drawableState));
//        if (isChecked()) {
//            mergeDrawableStates(drawableState, CHECKED_STATE_SET);
//            Log.d(TAG,"onCreateDrawableState()--checked-drawableState="+Arrays.toString(drawableState));
//        }
    ...
    protected void drawableStateChanged() {
        ...
        Log.d(TAG,"drawableStateChanged()--myDrawableState="+Arrays.toString(myDrawableState));
